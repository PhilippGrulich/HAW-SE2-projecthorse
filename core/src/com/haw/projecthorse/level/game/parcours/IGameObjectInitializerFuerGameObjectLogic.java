...
public interface IGameObjectInitializerFuerGameObjectLogic {
	...
	/**
	 * Berechnet auf Grundlage einer angegebenen Breite die H�he.
	 * @param regionWidth Breite der TextureRegion.
	 * @param regionHeight H�he der TextureRegion.
	 ...
	 * @param regionWidth Breite der TextureRegion.
	 * @param regionHeight H�he der TextureRegion.
	 * @param desiredHeight Neue H�he des ->GameObjects<-
	 * @return w Die, auf Grundlage der angegebenen H�he, berechnete Breite.
	 */
	 ...
	 * @param name Gew�nschter Name des GameObject.
	 * @param points Punkte, die bei Kollision des Players mit dem GameObject gutgeschrieben oder abgezogen werden.
	 * @param height Gew�nschte H�he des GameObjects. Breite wird automatisch gesetzt, sodass das Bild richtig Skaliert wird.
	 * @param duration Die Zeit in Sekunden die das GameObject ben�tigt, um von einem Ende zum anderen Ende des Screens zu gehen.
	 ...
	 * @return o Ein initialisertes GameObject wenn preconditions erf�llt sind, sonst null.

	 * @post Ein initialisertes GameObject wenn alle preconditions erf�llt sind, sonst null.
	 */
	public GameObject initGameObject(TextureRegion r, String name, int points, float height, float width, float duration, float x, float y, boolean collidable, boolean loot, boolean isMoveable);
